import { useState } from "react"
 ...
 export const Slider = ()=>{
    ...
    return(
        ...
        <div className="pirveli"> <img src={data[curimg]}/></div>
        <div className="meore"> {data.map(( ele,index)=>{
             return <img onClick={()=>big(index)} className="suratebi" src={ele} key={index}/>
        })}</div>
        </div>
